...
#include "fold_elevator_hardware_interface/socketcan_common.hpp"
...
////////////////////////////////////////////////////////////////////////////////
SocketCanDriver::~SocketCanDriver() noexcept
{
...
////////////////////////////////////////////////////////////////////////////////
SocketCanDriver::CanFilterList::CanFilterList(const char * str)
{
  *this = ParseFilters(str);
}

////////////////////////////////////////////////////////////////////////////////
SocketCanDriver::CanFilterList::CanFilterList(const std::string & str)
{
  *this = ParseFilters(str);
}

////////////////////////////////////////////////////////////////////////////////
SocketCanDriver::CanFilterList SocketCanDriver::CanFilterList::ParseFilters(
...
////////////////////////////////////////////////////////////////////////////////
void SocketCanDriver::SetCanFilters(const CanFilterList & filters)
{
...
////////////////////////////////////////////////////////////////////////////////
void SocketCanDriver::recv_wait(const std::chrono::nanoseconds timeout) const
{
...
void SocketCanDriver::send_wait(const std::chrono::nanoseconds timeout) const
{
  if (decltype(timeout)::zero() < timeout) {
    auto c_timeout = to_timeval(timeout);
...
////////////////////////////////////////////////////////////////////////////////
CanId SocketCanDriver::receive(void * const data, const std::chrono::nanoseconds timeout) const
{
  if (m_enable_fd) {
...
////////////////////////////////////////////////////////////////////////////////
CanId SocketCanDriver::receive_fd(void * const data, const std::chrono::nanoseconds timeout) const
{
  if (!m_enable_fd) {
